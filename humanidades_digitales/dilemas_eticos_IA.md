## Dilema ético 1: Sesgo en decisiones automatizadas
...
- ¿Quién es responsable del sesgo: el modelo, los datos o la organización?
- ¿Debe primar la eficiencia o la equidad?
- ¿Cómo debería auditarse el sistema?


## Dilema ético 2: Automatización sin supervisión

Una empresa implementa un sistema de IA para generar informes automáticos utilizados en decisiones internas.

Con el tiempo, los empleados comienzan a confiar plenamente en el sistema y dejan de revisar los resultados generados.
...
## Dilema ético 3: Uso de datos para entrenamiento

Un sistema de inteligencia artificial ha sido entrenado con grandes volúmenes de datos obtenidos de internet.

Parte de esos datos incluyen contenidos creados por terceros que no han autorizado explícitamente su uso.
...
- ¿Qué responsabilidad tienen las empresas que desarrollan estos modelos?



## Dilema ético 4: Dependencia de sistemas de IA
...
- ¿Debe limitarse el uso de estas herramientas?
...
Esto abre la puerta a la creación de deepfakes que pueden afectar a la reputación de personas u organizaciones.
...
- ¿Quién debe controlar el uso de estas herramientas?
