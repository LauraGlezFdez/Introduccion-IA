Este apartado recoge normativa española relevante para comprender el contexto regulatorio de la inteligencia artificial en España y su relación con el marco europeo.

# Normativa y guías en España sobre Inteligencia Artificial

Esta sección recoge referencias relevantes sobre normativa, guías técnicas y marcos institucionales relacionados con la inteligencia artificial en España.

---

# Guías oficiales de la Agencia Española de Supervisión de la Inteligencia Artificial (AESIA)

Portal oficial de guías:

https://aesia.digital.gob.es/es/guias

Las guías publicadas por AESIA proporcionan orientación práctica para facilitar la implementación del Reglamento Europeo de Inteligencia Artificial y apoyar a empresas y organizaciones en el cumplimiento normativo. :contentReference[oaicite:0]{index=0}
...
Esta ley desarrolla el Reglamento General de Protección de Datos en España e incluye disposiciones relacionadas con el tratamiento automatizado de datos y derechos digitales.
...
Esta norma establece mecanismos para prevenir la discriminación, incluyendo situaciones derivadas del uso de sistemas automatizados o tecnologías digitales.

---

## Carta de Derechos Digitales

https://portal.mineco.gob.es/RecursosArticulo/mineco/ministerio/participacion_publica/audiencia/ficheros/SEDIACartaDerechosDigitales.pdf

Documento estratégico del Gobierno de España que establece principios para garantizar los derechos de la ciudadanía en el entorno digital, incluyendo el uso responsable de la inteligencia artificial.
